...
<template>
    ...
    <MainLayout>
        ...
        >
            <div id="Header" class="flex items-center justify-between">
                <div class="flex flex-col gap-2">
                    <div
                        class="flex gap-1 items-center leading-5 text-desa-secondary"
                    >
                        <p
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a
                        href="/jadwal-desa/job-vacancy/edit"
            ...
            <div class="flex flex-col gap-[14px]">
                ...
                >
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        >
                            <img
                                src="@/assets/images/thumbnails/operator_produksi.jpg"
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center w-full gap-3">
                            ...
                            <div class="flex flex-col gap-1 w-full">
                                <p
                                    class="font-semibold text-xl leading-[22.5px] text-desa-red"
                                >
                                    Rp499.000
                                </p>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div class="flex items-center w-full gap-3">
                            ...
                            <div class="flex flex-col gap-1 w-full">
                                <p
                                    class="font-semibold text-xl leading-[22.5px] text-desa-yellow"
                                >
                                    12:30 WIB
                                </p>
                                <span class="font-medium text-desa-secondary">
                    ...
                    <div class="flex items-center w-full gap-3">
                        ...
                        <div class="flex flex-col gap-1 w-full">
                            <p
                                class="font-semibold text-xl leading-[22.5px] text-desa-blue"
                            >
                                9.250 Warga
                            </p>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <p class="font-medium leading-8">
                            Operator produksi adalah tenaga kerja yang bertugas
                            menjalankan proses produksi sesuai dengan standar
                            operasional perusahaan. Mereka berperan penting
                            dalam memastikan setiap tahap produksi berjalan
                            lancar, mulai dari menyiapkan bahan baku,
                            mengoperasikan mesin, hingga melakukan pengecekan
                            kualitas produk.
                        </p>
                    </div>
                </section>
                    ...
                    <div id="Tabs-Content" class="flex flex-col">
                        <div id="All" class="flex flex-col gap-6">
                            ...
                            >
                                ...
                                <div
                                    class="flex items-center gap-6 justify-between"
                                >
                                    <div
                                    ...
                                    >
                                        ...
                                        <div class="flex flex-col gap-1">
                                            <p
                                                class="font-semibold text-lg leading-5 text-desa-black"
                                            >
                                                Feri Prio Utomo
                                            </p>
                                            <p class="flex items-center gap-1">
                                    ...
                                    <div
                                        class="flex items-center gap-3 w-[236px] shrink-0"
                                    >
                                        <div class="flex flex-col gap-1">
                                            <p class="flex items-center gap-1">
                                                <img
                                    ...
                                    >
                                        ...
                                        >
                                            <span
                                                class="font-medium text-desa-red"
                                                >Tolak</span
                                            >
                                        </button>
                                        <button
        ...
        <div
            id="Modal-Delete"
            class="modal fixed inset-0 h-screen z-40 flex bg-[#080C1ACC] hidden"
        >
            <div
                id="Alert"
