...
<template>
  <div class="flex" role="main" aria-label="Dashboard">
    ...
    <main class="flex-1 p-6">
      ...
      <!-- Loading State -->
      <div v-if="isLoading && !statistics" class="flex justify-center items-center h-64" role="status" aria-live="polite">
        <LoadingSpinner size="lg" />
        <span class="sr-only">Loading dashboard data...</span>
      </div>
      
      <!-- Error State -->
      <div v-else-if="hasError" class="bg-white rounded-2xl p-6" role="alert" aria-live="assertive">
        <ErrorDisplay 
          :message="error" 
      ...
      <div v-else>
        <div id="Row-1" class="flex gap-6 mb-6">
          ...
          >
            <h2 id="bantuan-sosial-heading" class="sr-only">Bantuan Sosial Section</h2>
            <img
            ...
            <a href="#" class="flex items-center justify-between rounded-2xl p-4 gap-[10px] bg-white" aria-label="Bikin Bantuan Sosial">
          ...
          <section id="Statistics" class="grid grid-cols-2 flex-1 shrink-0 gap-[14px]" role="region" aria-label="Statistics">
            <StatCard
        ...
        <div id="Row-2" class="flex gap-[14px]">
          ...
          >
            <h2 id="bantuan-sosial-list-heading" class="sr-only">Daftar Bantuan Sosial</h2>
            <div class="flex flex-col gap-3 p-6">
              ...
              <div class="flex flex-col gap-[6px]">
                <p class="font-semibold text-[32px] leading-10">{{ statistics.socialAssistances }}</p>
          ...
          <section id="Event" class="flex flex-col flex-1 shrink-0 rounded-2xl bg-white" role="region" aria-label="Events">
            <div id="Date-Picker" class="flex flex-col gap-4 p-6" role="region" aria-label="Date Picker">
              <div class="flex items-center justify-between">
                <button
                ...
                <p class="font-semibold text-xl" aria-live="polite">September 2025</p>
                <button
                  class="flex items-center justify-center size-14 rounded-2xl border border-desa-foreshadow hover:border-desa-dark-green"
              ...
              <div class="flex justify-between" role="group" aria-label="Calendar days">
            ...
            <div id="Events" class="flex flex-col flex-1 gap-4 p-6" role="region" aria-label="Upcoming Events">
              <div class="flex items-center justify-between">
              ...
              >
                ...
                >
                  <p class="font-semibold text-xl leading-[25px]">Pengajian Bulanan</p>
        ...
        <div id="Row-3" class="flex gap-[14px]">
          <section id="Total-Aplicants" class="flex flex-col gap-[14px] w-[calc(603/1000*100%)]" role="region" aria-label="Job Applicants">
            <div class="flex flex-col flex-1 shrink-0 rounded-2xl bg-white">
              <div class="flex flex-col gap-3 p-6">
                ...
                <div class="flex flex-col gap-[6px]">
                  <p class="font-semibold text-[32px] leading-10">{{ statistics.jobApplicants }}</p>
                  <div class="flex items-center gap-0.5">
                    <img
                      src="@/assets/images/icons/trend-up-dark-green-fill.svg"
                      class="flex size-[18px] shrink-0"
            ...
            >
              ...
              <a href="#" class="flex items-center flex-nowrap rounded-2xl p-4 gap-[10px] bg-white" aria-label="Download Laporan">
          ...
          >
            <h2 id="population-statistics-heading" class="sr-only">Population Statistics</h2>
            <div class="flex items-center justify-between">
