  ...
  <div id="Row-1" class="flex gap-[14px]">
    ...
    <section id="Statistics" class="grid grid-cols-2 flex-1 shrink-0 gap-[14px]">
      ...
      <div class="card flex flex-col w-full rounded-2xl p-6 gap-3 bg-white">
        ...
        <div class="flex flex-col gap-[6px]">
          <p class="font-semibold text-[32px] leading-10">{{ dashboardData }}</p>
          <div class="flex items-center gap-0.5">
            <img
              src="@/assets/images/icons/trend-up-dark-green-fill.svg"
              class="flex size-[18px] shrink-0"
          ...
          <div class="flex flex-col gap-[6px] w-full">
            ...
            <div class="flex items-center gap-0.5 font-medium text-desa-secondary">
              <img
                ...
                alt="icon"
              />
              <span class="line-clamp-1"> Diberikan oleh RW 01 </span>
            </div>
          </div>
          <div
          ...
          <div class="flex flex-col gap-[6px] w-full">
            ...
            <div class="flex items-center gap-0.5 font-medium text-desa-secondary">
              <img
                ...
                alt="icon"
              />
              <span class="line-clamp-1"> Diberikan oleh oleh Warga Periuk Jaya </span>
            </div>
          </div>
          <div
          ...
          <div class="flex flex-col gap-[6px] w-full">
            ...
            <div class="flex items-center gap-0.5 font-medium text-desa-secondary">
              <img
                ...
                alt="icon"
              />
              <span class="line-clamp-1"> Diberikan oleh Bu Haji Ela </span>
            </div>
          </div>
          <div
            class="badge rounded-full p-3 gap-2 flex w-[100px] justify-center shrink-0 bg-desa-dark-green"
    ...
    <section id="Event" class="flex flex-col flex-1 shrink-0 rounded-2xl bg-white">
      <div id="Date-Picker" class="flex flex-col gap-4 p-6">
        <div class="flex items-center justify-between">
          ...
          <p class="font-semibold text-xl">September 2025</p>
          <button
            class="flex items-center justify-center size-14 rounded-2xl border border-desa-foreshadow hover:border-desa-dark-green"
          >
            <img
        ...
        <div class="flex flex-col gap-4 p-6">
          ...
          <div class="card flex items-center w-full gap-3">
            <div class="flex size-[72px] shrink-0 rounded-2xl bg-desa-foreshadow overflow-hidden">
              <img
                src="@/assets/images/thumbnails/PT Cingluh.jpg"
            ...
            <div class="flex flex-col gap-[6px] w-full">
              <div class="flex items-center gap-[6px]">
                ...
                <p class="font-medium text-xl leading-[22.5px] line-clamp-1">Fahmi</p>
              </div>
              <span class="font-medium text-desa-secondary line-clamp-1">
                Melamar Operator Produksi PT.Cingluh
              </span>
            </div>
            <div
              class="badge rounded-full p-3 gap-2 flex w-[100px] justify-center shrink-0 bg-desa-yellow"
          ...
          <div class="card flex items-center w-full gap-3">
            <div class="flex size-[72px] shrink-0 rounded-2xl bg-desa-foreshadow overflow-hidden">
              <img
                src="@/assets/images/thumbnails/PT Mayora.jpg"
                class="w-full h-full object-cover"
                alt="icon"
              />
            </div>
            <div class="flex flex-col gap-[6px] w-full">
              <div class="flex items-center gap-[6px]">
                ...
                <p class="font-medium text-xl leading-[22.5px] line-clamp-1">Mayang</p>
              </div>
              <span class="font-medium text-desa-secondary line-clamp-1">
                Melamar Operator Produksi PT.Mayora
              </span>
            </div>
            <div
              class="badge rounded-full p-3 gap-2 flex w-[100px] justify-center shrink-0 bg-desa-dark-green"
          ...
          <div class="card flex items-center w-full gap-3">
            <div class="flex size-[72px] shrink-0 rounded-2xl bg-desa-foreshadow overflow-hidden">
              <img
                src="@/assets/images/thumbnails/PT Panarub.jpeg"
                class="w-full h-full object-cover"
                alt="icon"
              />
            </div>
            <div class="flex flex-col gap-[6px] w-full">
              <div class="flex items-center gap-[6px]">
                ...
                <p class="font-medium text-xl leading-[22.5px] line-clamp-1">Sari</p>
              </div>
              <span class="font-medium text-desa-secondary line-clamp-1">
                Melamar Operator produksi PT.Panarub
              </span>
            </div>
            <div
              class="badge rounded-full p-3 gap-2 flex w-[100px] justify-center shrink-0 bg-desa-orange"
